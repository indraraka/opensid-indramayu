{{-- Garuda — banner Layanan Mandiri --}}
@if (theme_config('layanan_mandiri_box', '1') == '1' && setting('layanan_mandiri') == 1)
    @php
    ...
    <section class="grd-container" style="margin-top:var(--section-y,3rem);">
        <div class="grd-layanan">
            <div class="grd-layanan__intro">
                ...
                <p>Akses layanan administrasi {{ ucwords((string) setting('sebutan_desa')) }} secara online, kapan saja.</p>
            </div>
            ...
            <div class="grd-layanan__info">
                @if ($kantor)<img loading="lazy" src="{{ $kantor }}" alt="Kantor" class="grd-layanan__info-img">@endif
