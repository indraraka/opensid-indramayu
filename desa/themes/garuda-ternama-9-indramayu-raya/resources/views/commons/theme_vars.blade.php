{{-- Garuda Blade — palet & token identitas: Indramayu Raya (Dukuh) — biru navy regal + emas.
...
@php
    $grd_primary     = theme_config('gradient_left', '#1E3A6E');
    $grd_primary_end = theme_config('gradient_right', '#122444');
    $grd_accent      = theme_config('bgtop', '#C9A24A');
    $grd_secondary   = theme_config('warna_secondary', '#345B96');
    $grd_link        = theme_config('textlink', '#1B3361');
    $grd_link_hover  = theme_config('texthover', '#0F2140');
    $grd_scroll      = theme_config('withscroll', '#AEC2E6');
...
<style id="garuda-theme-vars">
    :root {
        ...
        --section-y: clamp(2.9rem,1.7rem + 3.4vw,5.2rem);
        --grd-container: 76rem;
        --grd-font-display: Georgia,"Times New Roman",serif;
