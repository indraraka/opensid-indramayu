...
<?php if (theme_config('layanan_surat', '1') == '1') : ?>
<?php
    $ok        = true;
    ...
    try {
        ...
        $hitung = static function ($kode, $bln, $thn) use ($LP) {
            return $LP::where('kode_peristiwa', $kode)
                ->whereMonth('tgl_lapor', $bln)
                ->whereYear('tgl_lapor', $thn)
                ->count();
        };
...
<section class="grd-container grd-perkembangan" style="margin-top:var(--section-y,3rem);">
    <div class="grd-perkembangan__col">
        ...
        <div class="grd-perkembangan__periods">
            <?php foreach (['bulan_ini' => 'Bulan Ini', 'bulan_lalu' => 'Bulan Lalu'] as $key => $judul) : ?>
            <div class="grd-perkembangan__period">
                <h4><?= $judul ?></h4>
                <div class="grd-perkembangan__tiles">
                    <?php
                        $ikon = ['Kelahiran' => 'fa-baby', 'Kematian' => 'fa-cross', 'Masuk' => 'fa-sign-in-alt', 'Pindah' => 'fa-sign-out-alt'];
    ...
    <div class="grd-perkembangan__col">
        ...
        <div class="grd-perkembangan__tiles grd-perkembangan__tiles--surat">
            <?php
                $surat_label = ['hari_ini' => 'Hari Ini', 'bulan_ini' => 'Bulan Ini', 'tahun_ini' => 'Tahun Ini', 'total' => 'Total'];
                foreach ($surat_label as $key => $label) :
            ?>
            <div class="grd-stat">
