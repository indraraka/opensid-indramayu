{{-- Garuda Blade — Motif Garuda Ternama 7 Bahari --}}
@php
    $grd_eyebrow = theme_config('hero_eyebrow', 'Desa Bahari');
    ...
    $grd_sub     = theme_config('hero_sub', 'Tangguh seperti nelayan, melaju bersama menuju desa yang berdaya.');
@endphp
<section class="grd-hero-wrap">
    <div class="grd-hero-motif grd-hero-motif--bahari">
      ...
      <defs>
        <linearGradient id="gtp7-sky" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--grd-primary)"/><stop offset="1" stop-color="var(--grd-primary-end)"/></linearGradient>
      ...
      <path d="M0 288 C 260 272 520 312 760 294 C 1040 272 1240 312 1440 294 L1440 320 L0 320 Z" fill="#0B5566"/>
        ...
        <div class="grd-hero-motif__inner">
            <span class="grd-hero-motif__eyebrow"><i class="fas fa-anchor"></i> {{ $grd_eyebrow }}</span>
