{{-- Garuda Blade — Motif Garuda Ternama 5 Kebun Mangga --}}
@php
    $grd_eyebrow = theme_config('hero_eyebrow', 'Kebun Mangga');
    ...
    $grd_sub     = theme_config('hero_sub', 'Hijau menyejukkan, panen melimpah — kearifan agraris warga desa.');
@endphp
<section class="grd-hero-wrap">
    <div class="grd-hero-motif grd-hero-motif--kebun-mangga">
      ...
      <defs>
        <linearGradient id="gtp5-sky" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--grd-primary)"/><stop offset="1" stop-color="var(--grd-primary-end)"/></linearGradient>
      ...
      <path d="M0 296 C 300 282 560 312 820 298 C 1080 284 1280 312 1440 300 L1440 320 L0 320 Z" fill="#0B3B4A"/>
        ...
        <div class="grd-hero-motif__inner">
            <span class="grd-hero-motif__eyebrow"><i class="fas fa-seedling"></i> {{ $grd_eyebrow }}</span>
