    ...
    <div class="bg-zinc-700 text-white py-6">
      <div class="grd-container text-sm flex flex-col gap-3 lg:flex-row justify-between items-center text-center lg:text-left">
        <span class="space-y-2">
            ...
            <p><span class="underline decoration-amber-400 underline-offset-1 decoration-2">Garuda Theme <?= THEME_VERSION ?></span> - <a href="https://opensid.my.id" class="underline decoration-green-500 underline-offset-1 decoration-2" target="_blank" rel="noopener">OpenSID <?= ambilVersi() ?></a> -
