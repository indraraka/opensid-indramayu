...
<?php /* Garuda Ternama 4 — Motif PANTAI SENJA (mercusuar, matahari terbenam, ombak) — full-bleed */ ?>
<section class="grd-hero-motif grd-hero-motif--full grd-hero-motif--senja">
  <svg class="grd-hero-motif__art" viewBox="0 0 1440 320" preserveAspectRatio="xMidYMax slice" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Ilustrasi mercusuar dan matahari terbenam di pantai">
    <defs>
      <linearGradient id="gtp4-sky" x1="0" y1="0" x2="0" y2="1">
        <stop offset="0" stop-color="#1E3A8A"/><stop offset=".55" stop-color="#2563EB"/><stop offset="1" stop-color="#38BDF8"/>
      </linearGradient>
  ...
  <div class="grd-container grd-hero-motif__inner">
    <span class="grd-hero-motif__eyebrow"><i class="fas fa-sun"></i> <?= theme_config('hero_eyebrow', 'Pesona Senja Pantai') ?></span>
    <h2 class="grd-hero-motif__title"><?= theme_config('hero_title', '') ?: ('Selamat Datang di ' . NAMA_DESA) ?></h2>
    <p class="grd-hero-motif__sub"><?= theme_config('hero_sub', 'Menyinari setiap langkah pembangunan desa, dari pesisir untuk warga.') ?></p>
  </div>
</section>
<style>
