...
<?php
    ...
    $grd_primary       = theme_config('gradient_left', '#3B36A8');
    $grd_primary_end   = theme_config('gradient_right', '#272163');
    $grd_accent        = theme_config('bgtop', '#7C74E8');
    $grd_secondary     = theme_config('warna_secondary', '#5249C8');
    $grd_link          = theme_config('textlink', '#2E2880');
    $grd_link_hover    = theme_config('texthover', '#1E1A5C');
    $grd_scroll        = theme_config('withscroll', '#CBC9F2');
