{{-- Garuda Blade — Motif Garuda Ternama 1 Pesisir --}}
@php
    $grd_eyebrow = theme_config('hero_eyebrow', 'Desa Pesisir');
    ...
    $grd_sub     = theme_config('hero_sub', 'Bersama membangun desa bahari yang maju, mandiri, dan sejahtera bagi seluruh warga.');
@endphp
<section class="grd-hero-wrap">
    <div class="grd-hero-motif grd-hero-motif--pesisir">
      ...
      <defs>
        <linearGradient id="gtp1-sky" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--grd-primary)"/><stop offset="1" stop-color="var(--grd-primary-end)"/></linearGradient>
      ...
      <path d="M0 288 C 240 270 520 312 760 292 C 1040 270 1240 312 1440 292 L1440 320 L0 320 Z" fill="#0B5566"/>
        ...
        <div class="grd-hero-motif__inner">
            <span class="grd-hero-motif__eyebrow"><i class="fas fa-water"></i> {{ $grd_eyebrow }}</span>
