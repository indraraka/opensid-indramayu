{{-- Garuda Blade — Motif Garuda Ternama 10 Batik Complongan --}}
@php
    $grd_eyebrow = theme_config('hero_eyebrow', 'Batik Complongan');
    ...
    $grd_sub     = theme_config('hero_sub', 'Negeri pembatik — melestarikan Batik Complongan khas Dermayon dari titik ke titik.');
@endphp
<section class="grd-hero-wrap">
    <div class="grd-hero-motif grd-hero-motif--batik">
      ...
      <defs>
        <linearGradient id="gtp10-bg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--grd-primary)"/><stop offset="1" stop-color="var(--grd-primary-end)"/></linearGradient>
      ...
      <path d="M0 296 C 240 282 520 312 760 298 C 1040 282 1240 312 1440 298 L1440 320 L0 320 Z" fill="#1A1550" opacity=".8"/>
        ...
        <div class="grd-hero-motif__inner">
            <span class="grd-hero-motif__eyebrow"><i class="fas fa-paint-brush"></i> {{ $grd_eyebrow }}</span>
