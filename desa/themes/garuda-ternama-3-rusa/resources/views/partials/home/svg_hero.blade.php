{{-- Garuda Blade — Motif Garuda Ternama 3 Rusa --}}
@php
    $grd_eyebrow = theme_config('hero_eyebrow', 'Khas Indramayu');
    ...
    $grd_sub     = theme_config('hero_sub', 'Anggun dan lestari — desa yang menjaga alam serta budaya warisan leluhur.');
@endphp
<section class="grd-hero-wrap">
    <div class="grd-hero-motif grd-hero-motif--rusa">
    ...
    <defs>
      <linearGradient id="gtp3-bg" x1="0" y1="0" x2="1" y2="1"><stop offset="0" stop-color="var(--grd-primary)"/><stop offset="1" stop-color="var(--grd-primary-end)"/></linearGradient>
    ...
    <g transform="translate(640 96)" fill="url(#gtp3-deer)" stroke="url(#gtp3-deer)">
      ...
      <g fill="none" stroke-width="7" stroke-linecap="round" stroke-linejoin="round">
        ...
        <div class="grd-hero-motif__inner">
            <span class="grd-hero-motif__eyebrow"><i class="fas fa-tree"></i> {{ $grd_eyebrow }}</span>
