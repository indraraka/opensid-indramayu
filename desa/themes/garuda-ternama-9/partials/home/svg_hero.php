...
<?php /* Garuda Ternama 9 — Motif INDRAMAYU RAYA (lambang gabungan: rusa, mangga, ombak) — full-bleed megah */ ?>
<section class="grd-hero-motif grd-hero-motif--full grd-hero-motif--raya">
  <svg class="grd-hero-motif__art" viewBox="0 0 1440 320" preserveAspectRatio="xMidYMid slice" xmlns="http://www.w3.org/2000/svg" role="img" aria-label="Lambang gabungan rusa, mangga, dan ombak khas Indramayu">
    <defs>
      <linearGradient id="gtp9-bg" x1="0" y1="0" x2="1" y2="1">
        <stop offset="0" stop-color="#115E59"/><stop offset="1" stop-color="#06302E"/>
      </linearGradient>
  ...
  <div class="grd-container grd-hero-motif__inner grd-hero-motif__inner--center">
    <span class="grd-hero-motif__eyebrow"><i class="fas fa-shield-alt"></i> <?= theme_config('hero_eyebrow', 'Indramayu Raya') ?></span>
    <h2 class="grd-hero-motif__title"><?= theme_config('hero_title', '') ?: ('Selamat Datang di ' . NAMA_DESA) ?></h2>
    <p class="grd-hero-motif__sub"><?= theme_config('hero_sub', 'Rusa, mangga, dan samudra — tiga jati diri desa dalam satu cita pembangunan.') ?></p>
  </div>
</section>
<style>
  ...
  .grd-hero-motif__eyebrow{display:inline-flex;align-items:center;gap:.4rem;background:rgba(234,179,8,.18);backdrop-filter:blur(3px);color:#FCE8A8;font-weight:700;font-size:.72rem;letter-spacing:.08em;text-transform:uppercase;padding:.3rem .85rem;border-radius:9999px;border:1px solid rgba(234,179,8,.4);}
  ...
  .grd-hero-motif__sub{color:rgba(255,255,255,.92);max-width:34rem;font-size:.95rem;text-shadow:0 1px 8px rgba(0,0,0,.45);margin:0;}
