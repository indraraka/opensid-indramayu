...
<?php
    ...
    $grd_primary       = theme_config('gradient_left', '#1E3A8A');
    $grd_primary_end   = theme_config('gradient_right', '#15275E');
    $grd_accent        = theme_config('bgtop', '#3E78E8');
    $grd_secondary     = theme_config('warna_secondary', '#2A4FA8');
    $grd_link          = theme_config('textlink', '#1E3A8A');
    $grd_link_hover    = theme_config('texthover', '#131F4A');
    $grd_scroll        = theme_config('withscroll', '#BFD0F0');
