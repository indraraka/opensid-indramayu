...
<section x-data="{catMenu: false}">
  ...
  <div
    ...
    <div class="flex lg:flex-row flex-col justify-between items-center relative z-10">
      ...
      <div class="flex flex-col lg:flex-row gap-3 mt-5 lg:mt-0 flex-wrap lg:justify-end items-center w-full px-3">
        <button type="button" data-grd-darktoggle aria-label="Ganti mode gelap/terang" aria-pressed="false" class="grd-darktoggle" title="Mode gelap/terang">
