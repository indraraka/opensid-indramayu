...
<div class="box box-primary box-solid">
  ...
  <div class="box-body">
    ...
    <button class="btn btn-accent btn-block mt-5"><a href="https://www.google.com/maps?q=<?=$data_config['lat'].",".$data_config['lng']?>" style="color:#fff;" target="_blank">Buka Peta</a></button>
  </div>
</div>
