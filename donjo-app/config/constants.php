...
define('maxPhpVersion', '8.4.99');
define('minMySqlVersion', '5.6.0');
define('maxMySqlVersion', '8.0.0');
define('minMariaDBVersion', '10.3.0');

// Polyfill: konstanta MYSQLI_TYPE_INTERVAL dihapus di PHP 8.4. Konstanta ini
// masih dirujuk oleh CI3 (system/database/drivers/mysqli/mysqli_result.php)
// pada peta tipe kolom; jika field_data() dipanggil atas objek result mysqli,
// PHP 8.4 akan fatal "Undefined constant". Nilainya 247 (= MYSQLI_TYPE_ENUM,
// persis seperti di PHP 8.2/8.3), sehingga perilaku peta tidak berubah.
defined('MYSQLI_TYPE_INTERVAL') || define('MYSQLI_TYPE_INTERVAL', 247);
