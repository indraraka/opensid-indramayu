...
class Laporan_penduduk_model extends MY_Model
{
    ...
    protected function select_per_kategori()
    {
        ...
        // Penjagaan: $lap kosong/null/false (mis. slug statistik tidak dikenal) akan
        // keliru cocok ke "case in_array(...)" di switch di bawah karena '' == false,
        // lalu mengirim null ke select_jml_penduduk_per_kategori(string ...) -> TypeError.
        // Samakan dengan perilaku cabang "default" (statistik '0').
        if ($lap === '' || $lap === null || $lap === false) {
            $lap = '0';
        }
