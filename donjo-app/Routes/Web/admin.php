...
// Web > Artikel > Impor Berita (dari situs WordPress/RSS eksternal)
Route::group('impor_berita', static function (): void {
    Route::get('/', 'Impor_berita@index')->name('impor_berita.index');
    Route::post('konfigurasi', 'Impor_berita@konfigurasi')->name('impor_berita.konfigurasi');
    Route::get('daftar', 'Impor_berita@daftar')->name('impor_berita.daftar');
    Route::post('impor', 'Impor_berita@impor')->name('impor_berita.impor');
});
