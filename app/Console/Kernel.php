...
class Kernel implements KernelContract
{
    ...
    protected $commands = [
        ...
        'App\Console\Commands\ImporBerita',
    ];
    ...
    {
        // Impor berita otomatis (hanya berjalan jika cron memanggil `schedule:run`).
        // Batas jumlah per hari diatur lewat setting `berita_import_limit`.
        $schedule->command('opensid:impor-berita')->dailyAt('07:00');
    }
